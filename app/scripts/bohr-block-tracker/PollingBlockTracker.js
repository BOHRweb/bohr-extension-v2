...
class PollingBlockTracker extends BaseBlockTracker_1.BaseBlockTracker {
    ...
    async _fetchLatestBlock() {
        ...
        console.log("eth_blockNumber _fetchLatestBlock_2")
        // {id: 648411409238933, jsonrpc: "2.0", result: "0xc7ca9a", error: undefined}
        // const res = await pify_1.default((cb) => this._provider.sendAsync(req, cb))();
        const res = await api.blockNumber({});
        res.result = '0x'+Number(res.result).toString(16)
