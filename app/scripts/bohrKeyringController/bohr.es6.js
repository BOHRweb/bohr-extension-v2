...
var Cast = /** @class */ (function () {
     ...
     * @returns {Long}
     */
    Cast.int64 = function (n) {
        return long_1.fromInt(n);
    };
    return Cast;
}());
...
var Hash = /** @class */ (function () {
     ...
     * @returns Uint8Array
     */
    Hash.h256 = function (input) {
        return blakejs_1(input, undefined, this.HASH_LEN);
    };
    /**
...
var IDLEN_BYTE = 6;
/**
 * This is a key codec for Bohr private/public key.
 * Ported from: https://github.com/str4d/ed25519-java/
 *
 * Private key format: PKCS#8
 * Public key format: X.509
 */
var KeyCodec = /** @class */ (function () {
    function KeyCodec() {
    }
    /**
     * Encode a private key into PKCS8 format.
     */
    KeyCodec.encodePrivateKey = function (seed) {
        var totlen = 16 + seed.length;
        var rv = new Uint8Array(totlen);
        var idx = 0;
        // sequence
        rv[idx++] = 0x30;
        rv[idx++] = (totlen - 2);
     ...
     */
    KeyCodec.decodePrivateKey = function (d) {
        //
        // Setup and OID check
        //
        var totlen = 48;
     ...
     */
    KeyCodec.encodePublicKey = function (publicKey) {
        var totlen = 12 + publicKey.length;
        var rv = new Uint8Array(totlen);
        var idx = 0;
        // sequence
        rv[idx++] = 0x30;
 ...
 * Ported from: https://github.com/BOHRweb/BoHr/blob/main/bohr-core/src/main/java/org/bohr/crypto/Key.java
 */
var Signature = /** @class */ (function () {
    /**
     * @throws {Error}
     */
    function Signature(signedMsg, publicKey) {
    ...
    Signature.prototype.getPublicKey = function () {
        return this.publicKey.slice();
    };
    Signature.prototype.getAddress = function () {
...
var Key = /** @class */ (function () {
    /**
     * Constructor of Bohr key-pair.
     */
    function Key(publicKey, privateKey, seed) {
    ...
    Object.defineProperty(Key, "PUBLIC_KEY_LEN", {
        get: function () {
            return 32;
        },
        enumerable: true,
    ...
    Object.defineProperty(Key, "ENCODED_PUBLIC_KEY_LEN", {
        get: function () {
            return 44;
        },
        enumerable: true,
    ...
    Object.defineProperty(Key, "PRIVATE_KEY_LEN", {
        get: function () {
            return 64;
        },
        enumerable: true,
    ...
    Object.defineProperty(Key, "ENCODED_PRIVATE_KEY_LEN", {
        get: function () {
            return 48;
        },
        enumerable: true,
    ...
    Object.defineProperty(Key, "SEED_LEN", {
        get: function () {
            return 32;
        },
        enumerable: true,
    ...
    Object.defineProperty(Key, "ADDRESS_LEN", {
        get: function () {
            return 20;
        },
        enumerable: true,
    ...
    Key.verify = function (message, signature) {
        return naclFast.sign.detached.verify(message, signature.getSignedMsg(), signature.getPublicKey());
    };
    /**
     * Generate a key-pair.
     */
    Key.generateKeyPair = function () {
        var seed = naclFast.randomBytes(Key.SEED_LEN);
        var keyPair = naclFast.sign.keyPair.fromSeed(seed);
        return new Key(keyPair.publicKey, keyPair.secretKey, seed);
    };
    /**
     * Import a PKCS8 encoded private key.
     */
    Key.importEncodedPrivateKey = function (pkcs8EncodedPrivateKey) {
        var seed = KeyCodec.decodePrivateKey(pkcs8EncodedPrivateKey);
        var keyPair = naclFast.sign.keyPair.fromSeed(seed);
        return new Key(keyPair.publicKey, keyPair.secretKey, seed);
    };
    ...
    Key.prototype.getEncodedPublicKey = function () {
        return this.encodedPublicKey.slice();
    };
    Key.prototype.getPrivateKey = function () {
        return this.privateKey.slice();
    };
    Key.prototype.getEncodedPrivateKey = function () {
        return this.encodedPrivateKey.slice();
    };
    Key.prototype.getSeed = function () {
        return this.seed.slice();
    };
    /**
     * Convert public key into a Bohr address.
     */
    Key.prototype.toAddressBytes = function () {
    ...
    Key.prototype.sign = function (message) {
        return new Signature(naclFast.sign.detached(message, this.getPrivateKey()), this.getPublicKey());
    };
    return Key;
}());
...
var Constants = /** @class */ (function () {
    ...
    Constants.COINBASE_KEY = Key.importEncodedPrivateKey(Buffer.from("302e020100300506032b657004220420d22f93f26b46a804154e4925f2fa33368f9f0332105729c6a44af3278ca0da84", "hex"));
    Constants.DEVNET_KEY = Key.importEncodedPrivateKey(Buffer.from("302e020100300506032b657004220420973315f6d25626626965abed804139b41b6610410c3e5023ae1a46b3016d48be", "hex"));
    return Constants;
}());
...
var Network = /** @class */ (function () {
    function Network(id, label) {
        this.id = id;
        this.label = label;
    }
    Object.defineProperty(Network, "MAINNET", {
        get: function () {
    ...
    Object.defineProperty(Network, "TESTNET", {
        get: function () {
    ...
    Object.defineProperty(Network, "DEVNET", {
        get: function () {
    ...
    Network.prototype.getLabel = function () {
        return this.label;
    };
    return Network;
}());
 ...
 */
var SimpleDecoder = /** @class */ (function () {
    function SimpleDecoder(bytes, from, to) {
        this.bytes = bytes;
        this.from = from;
        this.to = to;
        this.index = from;
    }
    SimpleDecoder.prototype.readBoolean = function () {
        this.require(1);
        return this.bytes[this.index++] !== 0;
    };
    SimpleDecoder.prototype.readByte = function () {
        this.require(1);
        return Cast.byte(this.bytes[this.index++]);
    };
    SimpleDecoder.prototype.readShort = function () {
        this.require(2);
        return Cast.int16((this.bytes[this.index++] & 0xFF) << 8 | (this.bytes[this.index++] & 0xFF));
    };
    SimpleDecoder.prototype.readInt = function () {
        this.require(4);
        return Cast.int32((this.bytes[this.index++] << 24) |
            (this.bytes[this.index++] & 0xFF) << 16 |
            (this.bytes[this.index++] & 0xFF) << 8 |
            (this.bytes[this.index++] & 0xFF));
    };
    SimpleDecoder.prototype.readLong = function () {
        var i1 = this.readInt();
        var i2 = this.readInt();
        return unsignedInt(i1).shiftLeft(32).or(unsignedInt(i2));
    };
    SimpleDecoder.prototype.readBytes = function () {
...
function unsignedInt(i) {
    return long_1.fromInt(i).and(long_1.fromString("0x00000000ffffffff", false, 16));
}
 ...
 */
var SimpleEncoder = /** @class */ (function () {
    function SimpleEncoder() {
        this.out = new Uint8Array(0);
    }
    SimpleEncoder.prototype.writeBoolean = function (b) {
        this.writeByte(b ? 1 : 0);
    };
    SimpleEncoder.prototype.writeByte = function (b) {
        var newOut = new Uint8Array(this.out.length + 1);
        newOut.set(this.out, 0);
        newOut[newOut.length - 1] = b;
        this.out = newOut;
    };
    SimpleEncoder.prototype.writeShort = function (i) {
        // cast i to int16
        var i16 = Cast.int16(i);
        this.writeByte(0xFF & (i16 >>> 8));
        this.writeByte(0xFF & (i16 >>> 0));
    };
    SimpleEncoder.prototype.writeInt = function (i) {
        // cast i to int32
        var i32 = Cast.int32(i);
        this.writeByte(0xFF & (i32 >>> 24));
        this.writeByte(0xFF & (i32 >>> 16));
        this.writeByte(0xFF & (i32 >>> 8));
        this.writeByte(0xFF & (i32 >>> 0));
    };
    SimpleEncoder.prototype.writeLong = function (l) {
        this.writeInt(l.shr(32).toInt());
        this.writeInt(l.toInt());
    };
    SimpleEncoder.prototype.writeBytes = function (bytes) {
        // write size
        this.writeSize(bytes.length);
        // write bytes
        var newOut = new Uint8Array(this.out.length + bytes.length);
        newOut.set(this.out, 0);
    ...
    SimpleEncoder.prototype.getWriteIndex = function () {
        return this.out.length;
    };
    SimpleEncoder.prototype.writeSize = function (size) {
        if (size < 0) {
...
var TransactionType = /** @class */ (function () {
    ...
    Object.defineProperty(TransactionType, "COINBASE", {
        get: function () { return new TransactionType(0x00); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "TRANSFER", {
        get: function () { return new TransactionType(0x01); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "DELEGATE", {
        get: function () { return new TransactionType(0x02); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "VOTE", {
        get: function () { return new TransactionType(0x03); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "UNVOTE", {
        get: function () { return new TransactionType(0x04); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "CREATE", {
        get: function () { return new TransactionType(0x05); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TransactionType, "CALL", {
        get: function () { return new TransactionType(0x06); },
        enumerable: true,
        configurable: true
    });
    TransactionType.of = function (code) {
        switch (code) {
            case 0x00:
    ...
    TransactionType.prototype.getCode = function () {
        return this.code;
    };
    TransactionType.prototype.equals = function (type) {
...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.getNetwork = function () {
        return this.network;
    };
     ...
     */
    Transaction.prototype.validate = function (network) {
        ...
        if (!long_1.isLong(this.getValue()) || this.getValue().lt(0)) {
            return new Error("Invalid value");
        }
        if (!long_1.isLong(this.getFee()) || this.getFee().lt(0)) {
            return new Error("Invalid fee");
        }
        if (!long_1.isLong(this.getNonce()) || this.getNonce().lt(0)) {
            return new Error("Invalid nonce");
        }
        if (!long_1.isLong(this.getTimestamp()) || this.getTimestamp().lt(0)) {
...
function encodeTx(tx) {
    ...
    var isVM = tx.getType().code === TransactionType.CALL.code || tx.getType().code === TransactionType.CREATE.code;
    if (isVM) {
...
function decodeTx(bytes) {
    ...
    var isVM = type === TransactionType.CALL || type === TransactionType.CREATE;
...
var Wallet = /** @class */ (function () {
    ...
    Wallet.generate = function (icapDirect) {
        ...
        var seed = naclFast.randomBytes(32);
        var keyPair = naclFast.sign.keyPair.fromSeed(seed);
        var key = new Key(keyPair.publicKey, keyPair.secretKey, seed);
        return new Wallet(toBuffer(key.getEncodedPrivateKey().buffer));
    };
    ...
    Wallet.prototype.getAddress = function () {
        var key = Key.importEncodedPrivateKey(this.privateKey);
        return toBuffer(key.toAddressBytes().buffer);
    };
    return Wallet;
}());
...
export { Bytes, Cast, Constants, Hash, Key, KeyCodec, Network, Signature, SimpleDecoder, SimpleEncoder, Transaction, TransactionType, Wallet };
//# sourceMappingURL=bohr.es6.js.map
