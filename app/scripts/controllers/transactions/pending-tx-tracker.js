  ...
  */
  ...
  async _checkPendingTx(txMeta) {
    ...
    try {
      ...
      const transactionResult = await api.transactionResult({hash:txHash});
      const transactionReceipt = transactionResult.result;
      transactionReceipt.transactionHash = txHash;
      transactionReceipt.cumulativeGasUsed ='0x'+ Number( transactionReceipt.gas).toString(16);
      transactionReceipt.gasUsed = '0x'+ Number( transactionReceipt.gasUsed).toString(16) ;
      transactionReceipt.status = '0x1';
      transactionReceipt.transactionIndex=null;
