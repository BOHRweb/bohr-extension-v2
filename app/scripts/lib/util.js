...
/**
 * Checks whether a given balance of BR, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value - The value of BR to send
 * @param {string} hexBalance - A balance of BR represented as a hex string
