...
import KeyringController from './bohrKeyringController/BohrKeyringController';
...
} from './bohr-currency-rate/assets/CurrencyRateController';
...
import contractMap from '../contract-bohrdata';
...
export default class MetamaskController extends EventEmitter {
  ...
  constructor(opts) {
    ...
    this.getOpenBoHrTabsIds = opts.getOpenBoHrTabsIds;
    ...
    const { ticker } = this.networkController.getProviderConfig();
    this.currencyRateController.configure({ nativeCurrency: ticker ?? 'BR' });
  ...
  getApi() {
    ...
    return {
      ...
      getOpenBoHrTabsIds: (cb) => cb(null, this.getOpenBoHrTabsIds()),
  ...
  async addNewAccount() {
    ...
    console.log("background.addNewAccount111");
  ...
  setupUntrustedCommunication(connectionStream, sender) {
    ...
    this.setupProviderConnection(mux.createStream('bohrmask-provider'), sender);
