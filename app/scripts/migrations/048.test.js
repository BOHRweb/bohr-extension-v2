...
describe('migration #48', function () {
  ...
  it('should convert hex transaction bohrNetworkId values to decimal', async function () {
    const oldStorage = {
      meta: {},
      data: {
        TransactionController: {
          transactions: [
            ...
            0,
            '',
            { foo: 'bar', bohrNetworkId: '1' },
            { foo: 'bar', bohrNetworkId: '0x1' },
            { foo: 'bar', bohrNetworkId: 'kaplar' },
            { foo: 'bar', bohrNetworkId: '0X2a' },
            { foo: 'bar', bohrNetworkId: '3' },
          ],
          bar: {
            baz: 'buzz',
          },
