...
class NetworkDropdown extends Component {
  ...
  renderCustomRpcList(rpcListDetail, provider) {
    ...
    return reversedRpcListDetail.map((entry) => {
      const { rpcUrl, chainId, ticker = 'BR', nickname = '' } = entry;
      ...
      return (
        ...
        >
          ...
          <span
            ...
            style={{
              color: isCurrentRpcTarget ? '#071d3d' : '#808080',
            }}
          >
            {nickname || rpcUrl}
          </span>
    ...
    return (
      ...
      >
        ...
        <span
          className="network-name-item"
          style={{
            color: providerType === network ? '#071d3d' : '#808080',
          }}
        >
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {/*{this.renderNetworkEntry('bohrnet')}*/}
        ...
        >
          ...
          <span
            className="network-name-item"
            style={{
              color: activeNetwork === 'custom' ? '#071d3d' : '#808080',
            }}
          >
