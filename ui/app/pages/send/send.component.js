...
export default class SendTransactionScreen extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    // If selecting BR after selecting a token, clear token related messages.
  ...
  validate(query) {
    ...
    console.log('validate------onChange-----input', query);
    if (query.length !== 35 || query.charAt(0) !== 'B') {
      this.setState({
    ...
    query = addressDecode16(query);
    console.log('validate-----input----decoded', query);
