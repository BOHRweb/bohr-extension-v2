...
import {addressDecode16,addressEncode} from "../../../../../mixins/mixin";
...
export default class EditContact extends PureComponent {
  ...
  state = {
    ...
    newAddress: addressEncode(this.props.address),
        ...
        <PageContainerFooter
          ...
          onSubmit={async () => {
            if (
              ...
              if (this.state.newAddress.length === 35 && this.state.newAddress.charAt(0) === 'B') {
                await removeFromAddressBook(chainId, address);
                await addToAddressBook(
                  addressDecode16(this.state.newAddress),
